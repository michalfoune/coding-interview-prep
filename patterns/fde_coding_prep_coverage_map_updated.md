...
| 20 | 🟠 | Binary search / first anomaly | Find first failing version/timestamp, first unhealthy state, threshold crossing, rotated sorted array basics | Covered: binary search. Important weak flank; do not over-invest, but know the boundary-search skeleton. |
