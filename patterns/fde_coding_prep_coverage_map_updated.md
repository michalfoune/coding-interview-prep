...
| 17 | ⬜ | String frequency / character counting | Given log labels, event types, or tokens, count frequencies and compare/group strings | Add. Covers anagrams, first non-repeating char, frequency comparison, token counts. Core structures: dict / Counter / sorted key. |
