...
def parse_incidents(rows: Iterable[dict[str, str]]) -> list[Incident]:
    """
    ...
    generator. Valid incidents are collected and returned as a list.
    ...
    The order of valid incidents matches the input order.
...
def main():
    ...
    incidents = parse_incidents(rows)
